...
<template>
  <footer class="border-t py-10">
    <div class="container mx-auto">
      <!-- top header -->
      <div
        class="top-layer flex-between border-b px-4 pb-10 grow gap-10 flex-wrap sm:justify-center"
      >
        ...
        <div class="follow-us h-full md:mb-0 sm:mb-10 sm:grow">
      ...
      <div class="container justify-center mx-auto">
        ...
        >
          ...
          <div class="flex gap-2">
            <img
              src="@/assets/icons/Western-union.svg"
