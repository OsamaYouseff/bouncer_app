...
<template>
  ...
  >
    <div
      class="img-container relative flex-center h-[270px] w-[270px] lg:grow-0 grow border-[#f6f7f8] border-4"
    >
    ...
    <div class="content grow px-6">
      ...
      <p
        class="dic text-start md:max-w-[570px] max-w-[370px] text-[14px] leading-7 mb-4"
      >
