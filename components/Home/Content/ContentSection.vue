...
<template>
  <section class="flex-col-center py-20" id="best-seller">
    <div class="container mx-auto">
      ...
      <div
        v-else
        class="product-container flex justify-center flex-wrap lg:p-10 p-0 gap-4"
      >
        <!-- product Box -->
        <Product
    ...
    <!-- load more -->
    <button
      @click="productsLimit += 5"
      class="mt-10 border-b-2 pb-3 px-0 mx-auto cursor-pointer h-10"
