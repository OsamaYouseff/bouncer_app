<template>
  <section class="product-section container mx-auto pb-10">
    <NavigationPath>
      ...
      <span>/</span>
      <NuxtLink to="/home#best-seller" class="active cursor-pointer  text-[11px] lg:text-[14px] text-[#c0c8ce]">
        Products
      </NuxtLink>
      <span>/</span>
      <NuxtLink class="text-[11px] lg:text-[14px] text-[#c0c8ce]">{{ product?.title }}</NuxtLink>
    </NavigationPath>
